...
HD_PWD='C:/Users/bhumm/OneDrive - TalTech/IAS0600_VHDL/project_6_FSM/project_6_FSM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gcd_fsm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gcd_fsm.tcl -notrace
