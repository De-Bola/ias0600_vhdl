...
HD_PWD='P:/IAS0600_VHDL/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HA_source.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HA_source.tcl
