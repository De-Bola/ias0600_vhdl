...
HD_PWD='P:/IAS0600_VHDL/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HA_source.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HA_source.tcl -notrace
