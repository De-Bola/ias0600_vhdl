...
HD_PWD='C:/Users/bhumm/OneDrive - TalTech/IAS0600_VHDL/project_3_CreepingLine/project_3_CreepingLine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FirstStep.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FirstStep.tcl
