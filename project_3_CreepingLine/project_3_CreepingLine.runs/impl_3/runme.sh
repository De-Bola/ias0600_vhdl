...
HD_PWD='C:/Users/bhumm/OneDrive - TalTech/IAS0600_VHDL/project_3_CreepingLine/project_3_CreepingLine.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log ThirdStep.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ThirdStep.tcl -notrace
