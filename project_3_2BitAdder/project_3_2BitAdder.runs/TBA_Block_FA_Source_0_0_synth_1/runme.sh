...
HD_PWD='P:/IAS0600_VHDL/project_3_2BitAdder/project_3_2BitAdder.runs/TBA_Block_FA_Source_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TBA_Block_FA_Source_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TBA_Block_FA_Source_0_0.tcl
