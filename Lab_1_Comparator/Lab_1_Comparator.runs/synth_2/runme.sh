...
HD_PWD='C:/Users/bhumm/OneDrive - TalTech/IAS0600_VHDL/Lab_1_Comparator/Lab_1_Comparator.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log whenStatement_designApproach.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source whenStatement_designApproach.tcl
