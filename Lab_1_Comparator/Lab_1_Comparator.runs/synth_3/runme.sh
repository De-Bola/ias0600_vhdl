...
HD_PWD='C:/Users/bhumm/OneDrive - TalTech/IAS0600_VHDL/Lab_1_Comparator/Lab_1_Comparator.runs/synth_3'
cd "$HD_PWD"
...
EAStep vivado -log withStatement_designApproach.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source withStatement_designApproach.tcl
