...
HD_PWD='C:/Users/bhumm/OneDrive - TalTech/IAS0600_VHDL/project_5_ParameterizedMultiplier/project_5_ParameterizedMultiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RCA_Source.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RCA_Source.tcl
