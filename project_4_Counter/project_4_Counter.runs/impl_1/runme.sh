...
HD_PWD='C:/Users/bhumm/OneDrive - TalTech/IAS0600_VHDL/project_4_Counter/project_4_Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter_with_Debouncer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Counter_with_Debouncer.tcl -notrace
