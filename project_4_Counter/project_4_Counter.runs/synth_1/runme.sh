...
HD_PWD='C:/Users/bhumm/OneDrive - TalTech/IAS0600_VHDL/project_4_Counter/project_4_Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter_with_Debouncer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Counter_with_Debouncer.tcl
