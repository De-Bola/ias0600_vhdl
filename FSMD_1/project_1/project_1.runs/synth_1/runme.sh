...
HD_PWD='C:/Users/adgbir/OneDrive - TalTech/IAS0600_VHDL/FSMD_1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gcd_fsm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gcd_fsm.tcl
